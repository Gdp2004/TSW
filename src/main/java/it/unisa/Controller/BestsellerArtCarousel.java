...
@WebServlet("/bestsellers-art")
public class BestsellerArtCarousel extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public BestsellerArtCarousel() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request,
        ...
        List<Books> bestsellers = dao.findByCategory("9");


        // 3) (Opzionale) Puoi salvarli in sessione se ti serve in JSP/JS
        request.getSession().setAttribute("art", bestsellers);
