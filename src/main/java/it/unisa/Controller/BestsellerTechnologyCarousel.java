...
@WebServlet("/bestsellers-technology")
public class BestsellerTechnologyCarousel extends HttpServlet {
    private static final long serialVersionUID = 1L;

    public BestsellerTechnologyCarousel() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request,
        ...
        List<Books> bestsellers = dao.findByCategory("14");


        // 3) (Opzionale) Puoi salvarli in sessione se ti serve in JSP/JS
        request.getSession().setAttribute("technology", bestsellers);
