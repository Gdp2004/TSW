...
<% 
  ...
  @SuppressWarnings("unchecked")
  List<Books> comingsoonBooks = (List<Books>) session.getAttribute("comingsoonBooks");
  if (comingsoonBooks == null) {
    Context initCtx = new InitialContext();
    Context envCtx  = (Context) initCtx.lookup("java:comp/env");
    DataSource ds   = (DataSource) envCtx.lookup("jdbc/Bookstore");
    BooksDao dao    = new BooksDao(ds);
    comingsoonBooks     = dao.findByCategory("2");
    session.setAttribute("comingsoonBooks", comingsoonBooks);
  }
%>
...
<h1>All Coming Soon Books</h1>

<div class="books-grid">
  <%
    if (comingsoonBooks != null && !comingsoonBooks.isEmpty()) {
      for (Books b : comingsoonBooks) {
  %>
    <div class="book-card">
