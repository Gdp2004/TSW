  ...
  <div id="header-wrapper">
    ...
    <div id="bar-row">
      <form method="get" action="" class="toggle-form">
        ...
        <button type="submit" id="dropdown-button" class="<%= dropdownActive ? "active" : "" %>">
          All <i class="fa-solid fa-chevron-down"></i>
        </button>
      </form>
      <form method="get" action="" class="search-form">
        <input type="text" id="search-input" name="search-query" placeholder="Search by Title, Author, Keyword or ISBN">
