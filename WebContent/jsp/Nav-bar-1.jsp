...
<nav id="nav-bar">
    ...
    <% if (username != null) { %>
        <div class="nav-link nav-link-account" id="accountMenu" style="display:flex; align-items:center; gap:6px;">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (accountText && logoutForm) {
            accountText.addEventListener('mouseenter', () => {
                accountText.style.display = 'none';
                logoutForm.style.display = 'inline-block';
            });

            logoutForm.addEventListener('mouseleave', () => {
